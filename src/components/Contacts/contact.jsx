...
const Contactt = () => {
  return (
    <section id='contacttt' className='min-h-[calc(100vh-4rem)]'>
    <div><h1 className='text-center font-bold text-5xl text-white'>Contact Me</h1></div>
    <h1 className='text-white text-center p-10'>Please fill out the bellow to discuss any work opportunity.</h1>
    <form className='flex flex-col items-center justify-center m-[1rem] mr-[auto] ml-[auto]  w-[90vw] max-w-[60rem]' action="">
      ...
      <button className='font-bold bg-white border-none pr-[3.75rem] pt-[0.75rem] pl-[3.75rem] pb-[0.75rem] rounded-xl m-[2rem] hover:bg-[#0bceaf]' type='submit' >Submit</button>
