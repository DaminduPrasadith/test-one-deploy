...
const Lightskills = () => {
  return (
    <section id='skilll'  className='pt-[4rem] min-h-[calc(100vh-4rem)] bg-white pb-[4rem]'>
        <h1   className='text-center font-bold  text-5xl'>SKILLS</h1>
    ...
    <div class="skills text-black bg-slate-300 p-10 rounded-lg">  
